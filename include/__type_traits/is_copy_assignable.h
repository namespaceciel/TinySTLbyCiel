#ifndef TINYSTLBYCIEL_INCLUDE___TYPE_TRAITS_IS_COPY_ASSIGNABLE_H_
#define TINYSTLBYCIEL_INCLUDE___TYPE_TRAITS_IS_COPY_ASSIGNABLE_H_
...
#endif //TINYSTLBYCIEL_INCLUDE___TYPE_TRAITS_IS_COPY_ASSIGNABLE_H_