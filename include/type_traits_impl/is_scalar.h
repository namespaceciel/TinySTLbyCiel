#ifndef TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_IS_SCALAR_H_
#define TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_IS_SCALAR_H_
...
#endif //TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_IS_SCALAR_H_