...
namespace ciel {
	...
	template<ciel::legacy_input_iterator InputIt1, ciel::legacy_input_iterator InputIt2>
	...
	template<ciel::legacy_input_iterator InputIt1, ciel::legacy_input_iterator InputIt2, class BinaryPredicate>
