#ifndef TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_ADD_POINTER_H_
#define TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_ADD_POINTER_H_
...
#endif //TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_ADD_POINTER_H_