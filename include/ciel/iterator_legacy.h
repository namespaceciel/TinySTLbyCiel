#ifndef TINYSTLBYCIEL_INCLUDE_CIEL_ITERATOR_LEGACY_H_
#define TINYSTLBYCIEL_INCLUDE_CIEL_ITERATOR_LEGACY_H_
...
namespace ciel{
	...
	class iterator_legacy    //所有迭代器的父类
	{
	public:
...
#endif //TINYSTLBYCIEL_INCLUDE_CIEL_ITERATOR_LEGACY_H_