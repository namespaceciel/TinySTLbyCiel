#ifndef TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_TYPE_LIST_H_
#define TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_TYPE_LIST_H_
...
#endif //TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_TYPE_LIST_H_