#ifndef TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_IS_COPY_ASSIGNABLE_H_
#define TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_IS_COPY_ASSIGNABLE_H_
...
#endif //TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_IS_COPY_ASSIGNABLE_H_