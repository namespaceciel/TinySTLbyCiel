#ifndef TINYSTLBYCIEL_INCLUDE___TYPE_TRAITS_IS_MOVE_CONSTRUCTIBLE_H_
#define TINYSTLBYCIEL_INCLUDE___TYPE_TRAITS_IS_MOVE_CONSTRUCTIBLE_H_
...
#endif //TINYSTLBYCIEL_INCLUDE___TYPE_TRAITS_IS_MOVE_CONSTRUCTIBLE_H_