#ifndef TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_ADD_REFERENCE_H_
#define TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_ADD_REFERENCE_H_
...
#endif //TINYSTLBYCIEL_INCLUDE_TYPE_TRAITS_IMPL_ADD_REFERENCE_H_